...
class PreReleaseValidator {
  ...
  private async validateScripts(): Promise<void> {
    ...
    const requiredScripts = [
      { script: '.ci/build/index.ts', name: 'Build script' },
      { script: '.ci/publish/index.ts', name: 'Publish script' },
      { script: '.ci/coherency/index.ts', name: 'Coherency script' },
      { script: '.ci/version/release.ts', name: 'Release script' }
    ];
